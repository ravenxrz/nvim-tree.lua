...
function M.on_attach_default(bufnr)
  ...
  vim.keymap.set("n",          "gws",            api.workspace.select,               opts("Workspace: Select"))
  vim.keymap.set("n",          "gwa",            api.workspace.add_folder,           opts("Workspace: Add Folder"))
  vim.keymap.set("n",          "gwd",            api.workspace.remove_folder,        opts("Workspace: Remove Folder"))
  vim.keymap.set("n",          "gwe",            api.workspace.edit_config,          opts("Workspace: Edit Config"))
